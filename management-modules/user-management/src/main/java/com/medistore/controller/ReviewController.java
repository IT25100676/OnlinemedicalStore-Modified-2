...
import com.medistore.service.ReviewService;
...
public class ReviewController {
    ...
    public String addReview(@RequestParam Long medicineId,
        ...
        try {
            ...
            Medicine medicine = medicineService.findById(medicineId)
                    .orElseThrow(() -> new RuntimeException("Medicine not found"));
            Review existingReview = reviewService.findByUserAndMedicine(user, medicine).stream()
                    .findFirst()
                    .orElse(null);
    ...
    public String editReview(@PathVariable Long id, @RequestParam int rating,
        ...
        try {
            ...
            return reviewService.findById(id)
                    .map(review -> "redirect:/reviews/add?medicineId=" + review.getMedicine().getId())
                    .orElse("redirect:/");
        }
    }
